...
export const en: Record<string, string> = {
  ...
  '{count} depo bulut AI’ya kapalı olduğu için dışarıda bırakıldı.':
    '{count} repositories were left out because cloud AI is off for them.',
  'Özetin varsayılan aralığı. Pencerede geçici olarak değiştirilebilir.':
    'Default period for the summary. It can be changed temporarily in the window.',
  'Bütün depolarında bu aralıkta ne yazdın, ne indi.':
    'What you wrote and what arrived across all your repositories in this period.',
  'Hareket yok': 'No activity',
  'Bu aralıkta hiçbir depoda commit yazılmamış ve indirilmemiş.':
    'No commits were written or pulled in any repository in this period.',
  'Yazdıkların': 'Written by you',
  'Gelenler': 'Arrived',
  '{count} commit yazdın': 'you wrote {count} commits',
  '{count} commit indi': '{count} commits arrived',
  '{count} depo': '{count} repositories',
  '1 saat': '1 hour',
  '6 saat': '6 hours',
  '24 saat': '24 hours',
  '7 gün': '7 days',
  'Bütün depolarda ne yazdın, ne indi': 'What you wrote and what arrived across all repositories',
  ...
  'İkili arama bitti': 'Bisect finished',
  'Şu an açık olan sürümde hata var mı?': 'Does the version you are on have the bug?',
  '{count} commit kaldı. Şu an açık olan sürümde hata var mı?':
    '{count} commits left. Does the version you are on have the bug?',
  'Hatayı getiren commit: {sha}': 'The commit that introduced the bug: {sha}',
  'Hatayı getiren commit bulundu': 'Found the commit that introduced the bug',
  'Sağlam': 'Good',
  'Hatalı': 'Bad',
  'Atla': 'Skip',
  'Bitir': 'Finish',
  'İşaretlenemedi': 'Could not mark',
  'Bitirilemedi': 'Could not finish',
  'Başlatılamadı': 'Could not start',
  'imza doğrulandı': 'signature verified',
  'imza güvenilmiyor': 'signature not trusted',
  'imza geçersiz': 'signature invalid',
  'imza doğrulanamadı': 'signature could not be checked',
  'alt modül': 'submodule',
  'yeni commit': 'new commit',
  'kaydedilmemiş': 'uncommitted',
  'takip edilmeyen': 'untracked',
  '{count} alt modül kurulmamış: {paths}': '{count} submodules are not installed: {paths}',
  'Kur': 'Install',
  'Alt modüller kuruldu': 'Submodules installed',
  'Alt modüller kurulamadı': 'Could not install submodules',
